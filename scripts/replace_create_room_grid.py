...
# From <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full"> 
# until the end of the room block:
#                             </div>
#                           </div>
#                         </div>
#                       ))}
                              ...
                              <div className="flex gap-1 h-[32px]">
                                <input
                                  ...
                                  onKeyDown={(e) => {
                                    if (e.key === 'Enter') {
                                      e.preventDefault();
                                      const parsed = parseTrAmount(roomPriceInput[room.id] ?? e.currentTarget.value);
                                      updateRoom(room.id, "price", parsed);
                                      setRoomPriceInput((prev) => ({
                                        ...prev,
                                        [room.id]: formatAmount(parsed),
