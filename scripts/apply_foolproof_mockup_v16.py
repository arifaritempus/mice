...
def apply_foolproof_mockup_v16(filepath):
                ...
                <div className={`bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-6 shadow-sm mb-8 animate-in fade-in slide-in-from-top-4 duration-300 ${isEditingInfo ? 'block' : 'hidden'}`}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-5 gap-4">
                    ...
                    <div>
                      ...
                      <input type="text" name="voucherNumber" value={salesData.voucherNumber} onChange={handleInputChange} className="w-full px-4 py-2 bg-gray-50/50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl text-xs font-bold text-[#1e293b] dark:text-gray-200 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all outline-none" placeholder="VOU-YENİ" required />
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex p-1 bg-gray-50/50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
                        <button type="button" onClick={() => handleInputChange({target: {name: 'customerType', value: 'agency'}} as any)} className={`flex-1 py-1.5 text-[10px] font-black tracking-widest rounded-lg transition-all ${salesData.customerType === 'agency' ? 'bg-white dark:bg-gray-700 text-blue-600 dark:text-blue-400 shadow-sm' : 'text-gray-500 hover:text-gray-700 dark:hover:text-gray-300'}`}>ACENTE</button>
                        <button type="button" onClick={() => handleInputChange({target: {name: 'customerType', value: 'individual'}} as any)} className={`flex-1 py-1.5 text-[10px] font-black tracking-widest rounded-lg transition-all ${salesData.customerType === 'individual' ? 'bg-white dark:bg-gray-700 text-blue-600 dark:text-blue-400 shadow-sm' : 'text-gray-500 hover:text-gray-700 dark:hover:text-gray-300'}`}>ŞAHIS</button>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      {salesData.customerType === 'agency' ? (
                        ...
                        <input type="text" name="customerName" value={salesData.customerName} onChange={handleInputChange} className="w-full px-4 py-2 bg-gray-50/50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl text-xs font-bold text-[#1e293b] dark:text-gray-200 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all outline-none" placeholder="Örn: Ahmet Yılmaz" />
                      )}
                    </div>

                    {/* Tarihler */}
                    <div>
                      <label className="block text-[10px] font-black text-gray-500 uppercase tracking-widest mb-2">Giriş - Çıkış *</label>
                      <div className="flex gap-2">
                        <input type="date" name="checkInDate" value={salesData.checkInDate} onChange={handleInputChange} className="w-full px-2 py-2 bg-gray-50/50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl text-[10px] font-bold text-[#1e293b] dark:text-gray-200 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all outline-none" />
                        <input type="date" name="checkOutDate" value={salesData.checkOutDate} onChange={handleInputChange} className="w-full px-2 py-2 bg-gray-50/50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl text-[10px] font-bold text-[#1e293b] dark:text-gray-200 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all outline-none" />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex p-1 bg-gray-50/50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700 h-[34px]">
                        {['BEKLEMEDE', 'KONFIRME', 'İPTAL'].map(status => (
                            <button key={status} type="button" onClick={() => handleInputChange({target: {name: 'status', value: status}} as any)} className={`flex-1 text-[12px] font-black tracking-tighter rounded-lg transition-all ${salesData.status === status ? (status === 'BEKLEMEDE' ? 'bg-amber-100 dark:bg-amber-900/30 text-amber-600' : status === 'KONFIRME' ? 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600' : 'bg-red-100 dark:bg-red-900/30 text-red-600') : 'text-gray-400 hover:text-gray-600 dark:hover:text-gray-300'}`}>
