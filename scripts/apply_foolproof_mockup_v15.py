...
def apply_foolproof_mockup_v15(filepath):
...
"""
    ...
    modern_info_and_form = """{/* Mockup Sejour Bilgileri */}
                ...
                {/* Mockup MODERN Düzenle Formu - NO OLD LAYOUT */}
    ...
    if "Mockup MODERN Düzenle Formu - NO OLD LAYOUT" not in content:
