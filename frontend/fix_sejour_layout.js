...
if (startIdx !== -1 && endIdx !== -1) {
        ...
        <div className="flex flex-wrap items-end gap-3 flex-1 xl:justify-end">
          ...
          <div className="w-[200px] shrink-0">
            <MultiTokenFilterInput
              ...
              onClearTokens={() => setVoucherTokens([])}
            />
          </div>
          <div className="w-[200px] shrink-0">
            <MultiTokenFilterInput
              ...
              onClearTokens={() => setCustomerTokens([])}
            />
          </div>
          <div className="w-[200px] shrink-0">
            <MultiTokenFilterInput
  ...
  // Also fix the table wrapper and header which were not modernized
  content = content.replace(
    ...
    '<div className="bg-[#0f172a]/40 backdrop-blur-md border border-white/10 rounded-2xl w-full min-w-0 flex-1 flex flex-col min-h-0 relative">'
  );
  ...
  console.log("Successfully replaced header, stats strip, and table headers.");
} else {
