...
function removeDateRangeField(filePath) {
  ...
  if (!result.includes("import DateRangeField from '@/components/DateRangeField'")) {
    result = result.replace(/import \{.*?\} from 'react';/, "$&\nimport DateRangeField from '@/components/DateRangeField';");
  }
...
removeDateRangeField('src/app/operations/tickets/page.tsx');
removeDateRangeField('src/app/operations/transfers/page.tsx');
removeDateRangeField('src/app/operations/guides/page.tsx');
removeDateRangeField('src/app/operations/part-time/page.tsx');
