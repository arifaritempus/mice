...
export default function ExchangeRatesPage() {
  ...
  // ResponsiveDateRangeField uses [Date | null, Date | null]
  ...
  // Sync date range back to custom start/end if period is custom
  ...
  return (
    <div className="h-[calc(100vh-2rem)] flex flex-col min-h-0 text-slate-100 p-4 sm:p-6 lg:p-8 overflow-hidden font-sans">
      {/* ═══════════════ HEADER ═══════════════ */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6 shrink-0 z-20">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1.5 font-medium ml-1">
        ...
        <div className="flex flex-wrap items-center gap-3">
          {/* Period Selector */}
          <div className="flex bg-[#0f172a]/60 backdrop-blur-md p-1 rounded-xl border border-white/10 shadow-inner">
            {([
          ...
          <button
            ...
            disabled={fetching}
            className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500 text-white text-sm font-bold rounded-xl shadow-lg shadow-emerald-500/20 disabled:opacity-50 disabled:cursor-not-allowed transition-all hover:-translate-y-0.5 active:translate-y-0"
          >
...
console.log('Done rewriting exchange rates');
