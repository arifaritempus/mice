      ...
      setCompanyInfo({
        company_name:
          ...
          (typeof document !== "undefined"
            ? document.title.split("-")[0].trim()
            : "Firma"),
        company_email: generalSettings.companyEmail || generalSettings.company_email || "info@tempustravel.co",
        ...
        company_website:
          generalSettings.companyWebsite || generalSettings.company_website || "www.tempustravel.co",
      });
    } catch (error) {
          ...
          <div className="mt-8">
                            ...
                            <div>
                              ...
                              <div className="flex gap-1">
                                <input
                                  ...
                                  inputMode="decimal"
                                  value={
                                    roomPriceInput[room.id] ??
                                    (room.price ? formatAmount(room.price) : "")
                                  }
                                  onChange={(e) =>
                                    setRoomPriceInput((prev) => ({
                                      ...prev,
                                  ...
                                  onBlur={(e) => {
                                    const parsed = parseTrAmount(
                                      roomPriceInput[room.id] ?? e.target.value,
                                    );
                      ...
                      {flights.map((flight, index) => (
                        ...
                        >
                          <div className="flex justify-between items-center mb-2">
                            ...
                            >
                              <span
                                className={`w-1 h-1 rounded-full mr-2 ${flight.type === "departure" ? "bg-emerald-500" : "bg-blue-500"}`}
                              ></span>
                              {flight.type === "departure"
                                ? "🚀 GİDİŞ UÇUŞU"
                                : "🛬 DÖNÜŞ UÇUŞU"}{" "}
                                ...
                                <input
                                  ...
                                  onBlur={(e) => {
                                    ...
                                    if (parsed !== null) {
                                      ...
                                      setServicePriceInput((prev) => ({
                                        ...prev,
                                        [transfer.id]: formatAmount(parsed),
                                      }));
                                    }
                                  }}
                                />
                  ...
                  <div className="p-1">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-2 responsive-filter-grid">
                            ...
                            {["TRY", "EUR", "USD", "GBP"].map((curr) => (
                              ...
                              >
                                ...
                                <span className="text-sm font-extrabold text-blue-600 dark:text-blue-400">
                                  {formatAmount(getTotalForCurrency(curr))}
                                </span>
                              </div>
                            ))}
                          </div>
                      ...
                      <div className="bg-indigo-50/50 dark:bg-indigo-900/10 p-1 rounded-lg border border-indigo-100 dark:border-indigo-900/30 flex flex-col items-center justify-center transition-all duration-300 hover:scale-[1.02]">
                        ...
                        <h4 className="text-[10px] font-bold text-indigo-800 dark:text-indigo-400 uppercase tracking-widest">
                          Uçuş Sayısı
                        </h4>
                        <p className="text-2xl font-black text-indigo-600 dark:text-indigo-300 mt-1">
                          {flights.length}
                        </p>
                      </div>
                      ...
                      <div className="bg-v3-surface border-2 border-red-100 dark:border-red-900/30 rounded shadow-xl">
                        <div className="px-2 py-1.5 bg-red-50 dark:bg-red-900/20/50 dark:bg-red-900/20 border-b border-red-100 dark:border-red-900/20 flex justify-between items-center">
                          <div className="flex items-center">
                            ...
                            <h3 className="text-[10px] font-black text-red-900 dark:text-red-100 tracking-widest uppercase">
                          ...
                          {rooms.map((room, index) => (
                            ...
                            >
                              <div className="flex flex-col lg:flex-row gap-2 items-end w-full lg:[&>*:nth-child(1)]:flex-[2] lg:[&>*:nth-child(2)]:flex-[1.5] lg:[&>*:nth-child(3)]:flex-[2] lg:[&>*:nth-child(4)]:flex-[1.5]">
                                ...
                                <div>
                                  <label className="block text-[10px] font-black text-red-600 dark:text-red-400 uppercase tracking-widest mb-2 ml-1">
                                    Alış Tutarı
                                  </label>
                                  <input
                                    type="text"
                                    inputMode="decimal"
                                    value={
                                      servicePriceInput[`${room.id}_cost`] ??
                                      (room.costPrice
                              ...
                              <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                                ...
                                <div>
                                  ...
                                  <input
                                    ...
                                    inputMode="decimal"
                                    value={
                                      servicePriceInput[`${flight.id}_cost`] ??
                                      (flight.costPrice
                                    ...
                                    onChange={(e) =>
                                      setServicePriceInput((prev) => ({
                                        ...prev,
                                        [`${flight.id}_cost`]: normalizeTyping(
                                          e.target.value,
                                        ),
                                      }))
                                    }
                          ...
                          {["TRY", "EUR", "USD", "GBP"].map((curr) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                <span
                                  className={`text-sm font-black ${profit >= 0 ? "text-emerald-600" : "text-red-600"}`}
                                >
                                  {profit >= 0 ? "+" : ""}
                                  {formatAmount(profit)}
                                </span>
            ...
            {activeTab === "collections" && (
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <div className="space-y-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                        ...
                        <div className="space-y-3">
                          {collections.map((collection) => (
                            <div
                              key={collection.id}
                              className="grid grid-cols-1 md:grid-cols-6 gap-3 items-center bg-gray-50/50 dark:bg-gray-700/20 p-3 rounded border border-gray-100 dark:border-gray-700 hover:border-emerald-200 dark:hover:border-emerald-800 transition-all duration-200"
                            >
                              <select
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 pt-2 responsive-filter-grid">
                  <div className="bg-blue-500/10/50 dark:bg-blue-900/10 p-1 rounded-lg border border-blue-100 dark:border-blue-900/30 transition-all duration-300 hover:scale-[1.02]">
                    <h3 className="text-[10px] font-bold text-blue-800 dark:text-blue-400 uppercase tracking-widest mb-3">
                      Toplam Tutarlar
                    </h3>
                      ...
                      {["TRY", "EUR", "USD", "GBP"].map((curr) => (
                        ...
                        >
                          ...
                          <span className="text-sm font-extrabold text-emerald-600 dark:text-emerald-400">
                            {formatAmount(
                              calculateTotalCollectionsByCurrency(curr),
                            )}
                          </span>
                        </div>
                      ))}
                    ...
                    <div className="space-y-1.5">
                      {["TRY", "EUR", "USD", "GBP"].map((curr) => (
                        ...
                        >
                          ...
                          <span
                            className={`text-sm font-extrabold ${calculateBalanceByCurrency(curr) > 0 ? "text-red-600 dark:text-red-400" : "text-emerald-600 dark:text-emerald-400"}`}
                          >
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-2 pt-2 border-t border-v3-border mt-2 mb-20 animate-in slide-in-from-bottom-8 duration-700">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full md:w-auto h-9 px-16 bg-blue-500 text-white text-[10px] font-black tracking-widest rounded shadow-xl shadow-blue-500/20 hover:bg-blue-500/90 active:scale-95 disabled:opacity-50 transition-all"
              >
                {loading ? (
