...
export async function POST(
  ...
  try {
    ...
    console.log('🔵 Next.js API Route: Gönderilen body:', JSON.stringify(body, null, 2));
    ...
    try {
      ...
      return NextResponse.json({
        ...
        details: fetchError?.message || 'Backend çalışmıyor olabilir. Lütfen backend sunucusunun çalıştığından emin olun.',
        backendUrl
      }, { status: 503 });
    }
    ...
    console.log('🔵 Next.js API Route: Backend response data:', JSON.stringify(data, null, 2));
