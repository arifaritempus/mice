...
export default function OtherServicesTab({
  ...
  const filteredOtherServiceSuppliers = useMemo(() => {
    ...
    if (!otherServiceSupplierSearch || !otherServiceSupplierSearch.trim())
      return allSuppliers;
    ...
    return allSuppliers.filter(
      (item: any) =>
        (item.name &&
          item.name
            .toLowerCase()
            .includes(otherServiceSupplierSearch.toLowerCase())) ||
        (item.title &&
          item.title
            .toLowerCase()
            .includes(otherServiceSupplierSearch.toLowerCase())) ||
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-xs">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              {editingOtherServiceIndex !== null &&
                editingOtherServiceIndex === otherServices.length && (
                    ...
                    <>
                        ...
                        <input
                          ...
                          onKeyDown={(e) => {
                            if (e.key === "Enter") {
                              ...
                              if (
                                showOtherServiceSupplierDropdown &&
                                selectedOtherServiceSupplierIndex >= 0 &&
                                selectedOtherServiceSupplierIndex <
                                  filteredOtherServiceSuppliers.length
                              ) {
                                const supplier =
                                  filteredOtherServiceSuppliers[
                                    selectedOtherServiceSupplierIndex
                                  ];
                                ...
                                const updatedTempOtherServiceItem = {
                                  ...
                                  supplier:
                                    currentInputValue ||
                                    tempOtherServiceItem?.supplier ||
                                    "",
                                  hotel:
                                    currentInputValue ||
                                    tempOtherServiceItem?.hotel ||
                                    "",
                                };
                                setTempOtherServiceItem(
                                  updatedTempOtherServiceItem,
                                );
                                handleOtherServiceSave();
                              }
                            } else if (e.key === "Escape") {
                      ...
                      <td className="px-2 py-2">
                        <input
                          ...
                          onBlur={(e) => {
                            ...
                            const value =
                              parseTurkishNumber(e.target.value) || 1;
                            setOtherServiceFxInput(
                      ...
                      <td className="px-2 py-2">
                        <div className="flex gap-1">
                          ...
                          <button
                            onClick={handleOtherServiceCancel}
              ...
              editingOtherServiceIndex === null ? (
                <tr>
                  ...
                  >
                    Henüz diğer servis eklenmemiş
                  </td>
                </tr>
              ) : (
                filteredOtherServices.map((item, index) => {
                  // Orijinal index'i bul (filteredOtherServices'deki index değil, otherServices'deki index)
                  const originalIndex = otherServices.findIndex(
                    (os) => os.id === item.id,
                  );
                  return (
                    <tr
                        ...
                        <>
                          ...
                          <td className="px-2 py-2 text-gray-900 dark:text-white">
                            <div className="flex gap-1">
                              <button
                                onClick={() =>
                                  handleOtherServiceEdit(originalIndex)
                                }
                              ...
                              <button
                                onClick={() =>
                                  handleOtherServiceDelete(originalIndex)
                                }
        ...
        <div className="bg-blue-500 dark:bg-blue-700 rounded-md p-3">
          <div className="grid grid-cols-12 gap-2 text-white text-sm responsive-filter-grid">
            ...
            <div className="col-span-6 text-right font-bold">
              {Object.entries(otherServicesTotals)
                .map(
                  ([cur, val]: any) =>
            ...
            {filteredOtherServiceSuppliers.length > 0 ? (
              filteredOtherServiceSuppliers.map((supplier, index) => (
                <div
                  ...
                  onMouseEnter={() =>
                    setSelectedOtherServiceSupplierIndex(index)
                  }
