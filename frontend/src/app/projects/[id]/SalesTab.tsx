                  ...
                  <div className="space-y-4">
                    {mainCategories.length === 0 ? (
                      ...
                      mainCategories.map((mainCat: any) => {
                        ...
                        const isExpanded = expandedCategoriesSales.has(
                          mainCat.id,
                        );
                          ...
                          >
                            ...
                            <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                              <div className="flex items-center gap-2 flex-1">
                                <button
                                  onClick={() =>
                                    toggleCategoryExpansion(mainCat.id, "sales")
                                  }
                              ...
                              <div className="p-3 bg-white dark:bg-gray-800 space-y-1 border-t border-gray-200 dark:border-v3-border">
                                {subCats.map((subCat: any) => (
                                  ...
                                  >
                                    <input
                                      type="checkbox"
                                      checked={selectedCategoriesSales.has(
                                        subCat.id,
                                      )}
                                      onChange={(e) => {
                      ...
                      <input
                        ...
                        onKeyDown={(e) => {
                          if (e.key === "Enter") {
                            ...
                            setItemsSales((prev) =>
                              prev.map((p) =>
                                p.id === it.id ? { ...p, isEditing: false } : p,
                              ),
                            );
                          }
                        }}
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (fxVal > 0 && qtyTimesRepeat > 0) {
                            newUnitPrice =
                              Number(newTotalTRY || 0) / fxVal / qtyTimesRepeat;
                          }
