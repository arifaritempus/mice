...
export default function InsanKaynaklariTab(props: InsanKaynaklariTabProps) {
  ...
  const [hrSupplierDropdownPosition, setHrSupplierDropdownPosition] = useState<{
    top: number;
    left: number;
    width: number;
  } | null>(null);
          ...
          <div className="grid grid-cols-4 gap-4 text-xs">
            ...
            <div>
              ...
              <div className="text-lg font-bold text-green-600">
                ...
                {humanResources
                  .reduce(
                    (sum, e) => sum + parseFloat(e.totalTRY || e.total_tl || 0),
                    0,
                  )
                  .toLocaleString("tr-TR", {
                    minimumFractionDigits: 2,
                  ...
                  <td className="px-2 py-2">
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        const selectedSubCategory = hrSubCategories.find(
                          (sub) => sub.name === selectedValue,
                        );
                        setTempHrItem((prev) => ({
                          ...prev,
                    ...
                    <input
                      ...
                      onKeyDown={(e) => {
                        if (e.key === "Enter") {
                          ...
                          const cleanValue = currentInputValue.replace(
                            /[^\d,]/g,
                            "",
                          );
                          const numericValue = parseTurkishNumber(cleanValue);
                  ...
                  <td className="px-2 py-2">
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        const amount =
                          parseTurkishNumber(hrAmountInput || "0") ||
                          parseFloat(tempHrItem?.amount || "0");
                        const fx = parseTurkishNumber(hrFxInput || "1");
                        // Toplam TL = Tutar * Kur
                  ...
                  <td className="px-2 py-2">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        const cleanValue = inputValue.replace(/[^\d,]/g, "");
                        const numericValue =
                          parseTurkishNumber(cleanValue) || 1;
                    ...
                    <div className="flex space-x-2">
                      <button
                        onClick={async () => {
                          ...
                          const itemToPass =
                            tempHrItem &&
                            typeof tempHrItem === "object" &&
                            Object.keys(tempHrItem).length > 0
                              ? tempHrItem
                              : undefined;
                  ...
                  >
                          ...
                          onKeyDown={(e) => {
                            if (e.key === "Enter") {
                              ...
                              const updatedTempHrItem = {
                                ...tempHrItem,
                                hotel:
                                  currentInputValue || tempHrItem?.hotel || "",
                              };
                              // hrSupplierSearch state'ini de güncelle
                              setHrSupplierSearch(currentInputValue);
                              handleHrSave(updatedTempHrItem);
                      ...
                      {editingHrIndex === extra.originalIndex ? (
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            // Toplam TL input'unu da güncelle
                            setHrTotalTRYInput(
                              formatNumberForDisplay(newTotalTRY),
                            );
                          }}
                          onKeyDown={(e) => {
                            if (e.key === "Enter") {
                      ...
                      {editingHrIndex === extra.originalIndex ? (
                        <select
                          ...
                          onChange={(e) => {
                            ...
                            const amount =
                              parseFloat(hrAmountInput.replace(",", ".")) ||
                              parseFloat(tempHrItem?.amount || "0");
                            const fx =
                              parseFloat(hrFxInput.replace(",", ".")) || 1;
                            // Toplam TL = Tutar * Kur
                            const totalTRY = amount * fx;
                            setTempHrItem((prev) => ({
                              ...prev,
                      ...
                      {editingHrIndex === extra.originalIndex ? (
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            const numericValue =
                              parseFloat(cleanValue.replace(",", ".")) || 1;
                            const amount =
                              parseFloat(hrAmountInput.replace(",", ".")) || 0;
                            const newTotalTRY =
                              numericValue > 0 ? amount * numericValue : amount;
                        ...
                        <span className="text-gray-900 dark:text-white text-right block">
                          {formatNumberForDisplay(
                            extra.exchange_rate || extra.fx || 1,
                          )}
                        </span>
                      )}
                    </td>
                    <td className="px-2 py-2">
                      {editingHrIndex === extra.originalIndex ? (
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            setTempHrItem((prev) => ({
                              ...
                              totalTRY: numericTotalTRY,
                              amount:
                                newAmount > 0 ? newAmount : prev.amount || 0,
                            }));
                        ...
                        <span className="text-gray-900 dark:text-white text-right block">
                          {formatNumberForDisplay(
                            extra.totalTRY || extra.total_try || 0,
                          )}
                        </span>
                      )}
                    </td>
            ...
            {allSuppliers
              .filter((s) =>
                (s.displayName || s.name || "")
                  .toLowerCase()
                  .includes(hrSupplierSearch?.toLowerCase() || ""),
              )
              .map((supplier, index) => (
                <div
                  ...
                  onClick={() =>
                    handleHrSupplierSelect(supplier, tempHrItem?.id || "")
                  }
