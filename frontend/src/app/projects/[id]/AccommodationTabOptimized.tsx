...
const getDynamicHeaders = (accommodationItems: any[]) => {
  ...
  accommodationItems.forEach((item) => {
    const checkIn = parseDate(
      item.gelis_tarihi || item.giris_tarihi || item.checkin_date,
    );
  ...
  accommodationItems.forEach((item) => {
    const checkOut = parseDate(
      item.cikis_tarihi || item.cikis_tarihi || item.checkout_date,
    );
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <label
              ...
              className="px-3 py-1.5 text-xs bg-blue-500 text-white rounded hover:bg-blue-500/90 cursor-pointer transition-colors whitespace-nowrap"
            >
              Excel İçe Aktar
            </label>
              ...
              <table className="min-w-full text-xs">
                        ...
                        return (
                          <th
                            ...
                            className={`${getColumnWidth(header)} px-2 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider ${
                              header === "İŞLEMLER"
                                ? "sticky left-0 bg-gray-50 dark:bg-gray-700 z-10"
                                : ""
                            }`}
                          >
                            <div
                              className={`flex flex-col ${isNameColumn ? "items-start text-left" : "items-center text-center"}`}
                            >
                              <span className="leading-tight font-semibold">
                                {header.split(" ")[0]}
                              </span>
                              {header.includes(" ") && (
                                <span className="leading-tight text-xs opacity-75">
                ...
                <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-600">
                  {filteredItems.map((item, index) => {
                    const originalIndex = accommodationItems.findIndex(
                      (x: any) => x.id === item.id,
                    );
                    return (
                      <tr
                          ...
                          <div className="flex justify-center space-x-1">
                            {editingAccommodationIndex === originalIndex ? (
                              ...
                              <>
                                ...
                                <button
                                  onClick={() =>
                                    handleAccommodationCopy(item.id)
                                  }
                                ...
                                <button
                                  onClick={() =>
                                    handleAccommodationAdd(item.id)
                                  }
                                  className="p-1 bg-green-600 text-white rounded hover:bg-green-700"
                                  title="Ekle"
                                >
                                ...
                                <button
                                  ...
                                  className="p-1 bg-blue-500 text-white rounded hover:bg-blue-500/90"
                                  title="Düzenle"
                                >
                                  <svg
                                    className="w-3 h-3"
                          ...
                          hotelFilteredItems.forEach((accItem) => {
                            const checkIn = parseDate(
                              accItem.gelis_tarihi ||
                                ...
                                accItem.checkin_date,
                            );
                            if (
                              checkIn &&
                              (!earliestDate || checkIn < earliestDate)
                            ) {
                              earliestDate = checkIn;
                            }
                          });
                          ...
                          hotelFilteredItems.forEach((accItem) => {
                            const checkOut = parseDate(
                              accItem.cikis_tarihi ||
                                accItem.cikis_tarihi ||
                                accItem.checkout_date,
                            );
                            if (
                              checkOut &&
                              (!latestDate || checkOut > latestDate)
                            ) {
                              latestDate = checkOut;
                            }
                          });
        ...
        {hotelFilteredItems.length > 0 &&
          (() => {
            ...
            const sortedRoomTypes = roomTypeOrder.filter((roomType) =>
              allRoomTypes.has(roomType),
            );
                    ...
                    <table className="min-w-full text-xs">
                      <thead className="bg-gray-50 dark:bg-gray-700">
                        <tr>
                          ...
                          {sortedRoomTypes.map((roomType) => (
                            <th
                              key={roomType}
                              className="px-2 py-2 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider"
                            >
                              {roomType}
                            </th>
                          ))}
                      ...
                      <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-600">
                        {allDates.map((date, index) => {
                          ...
                          Object.entries(groupedByRoomNumber).forEach(
                            ([roomNo, roomGroup]) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              {sortedRoomTypes.map((roomType) => (
                                <td
                                  key={roomType}
                                  className="px-2 py-2 text-center text-xs text-gray-900 dark:text-white"
                                >
                        ...
                        <tr className="font-semibold">
                          ...
                          {(() => {
                            ...
                            return sortedRoomTypes.map((roomType) => (
                              <td
                                key={roomType}
                                className="px-2 py-2 text-center text-xs text-gray-900 dark:text-white bg-blue-500/10 dark:bg-blue-900/20"
                              >
                                {totalRoomTypeCounts[roomType] || 0}
                              </td>
                            ));
