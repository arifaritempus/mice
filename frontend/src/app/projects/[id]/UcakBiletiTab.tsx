          ...
          <table className="w-full text-xs">
            <thead className="bg-gray-100 dark:bg-gray-700">
              <tr>
                ...
                <th
                  className="px-2 py-2 text-left font-semibold text-gray-900 dark:text-white w-32 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 select-none"
                ...
                <th
                  className="px-2 py-2 text-left font-semibold text-gray-900 dark:text-white w-20 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 select-none"
                ...
                <th className="px-2 py-2 text-left font-semibold text-gray-900 dark:text-white w-24">PNR</th>
                <th className="px-2 py-2 text-left font-semibold text-gray-900 dark:text-white w-20">UÇUŞ TİPİ</th>
                ...
                <th className="px-2 py-2 text-left font-semibold text-gray-900 dark:text-white w-24">GİDİŞ UÇUŞ KODU</th>
                ...
                <th className="px-2 py-2 text-left font-semibold text-gray-900 dark:text-white w-24">DÖNÜŞ UÇUŞ KODU</th>
                <th className="px-2 py-2 text-left font-semibold text-gray-900 dark:text-white w-32 whitespace-nowrap">GÜZERGAH</th>
                <th
                ...
                <th className="px-2 py-2 text-left font-semibold text-gray-900 dark:text-white w-48">MİSAFİRLER</th>
                        ...
                        <td className="px-2 py-2 relative">
                          <div className="relative">
                            <input
                              ...
                              className="w-full px-1 py-0.5 text-xs border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-800 text-gray-900 dark:text-white cursor-pointer"
                              readOnly
                            />
