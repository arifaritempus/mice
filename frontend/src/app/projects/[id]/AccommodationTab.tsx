          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
            <div className="px-0 py-1 border-b border-gray-200 dark:border-gray-700 flex items-center justify-start">
              <input
                ...
                className="w-[36rem] px-3 py-2 text-xs rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
                ...
                <thead className="bg-gray-100 dark:bg-gray-700">
                  <tr>
                    {FIXED_HEADERS.map((header, index) => (
                      <th key={`header-${index}-${header}`} className="px-3 py-2 text-left font-semibold">{header}</th>
                    ))}
                    <th className="px-3 py-2 text-center font-semibold">İşlemler</th>
                  </tr>
                </thead>
                <tbody>
                      ...
                      <tr key={uniqueKey} className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                        {editingAccommodationIndex === index ? (
                          <>
                            ...
                            <td className="px-3 py-2">
                              <input
                                ...
                                onChange={(e) => setTempAccommodationItem({...tempAccommodationItem, tarih1: e.target.value})}
                                className="w-full px-2 py-1 text-xs border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                              />
                            </td>
                            <td className="px-3 py-2">
                              <input
                                ...
                                onChange={(e) => setTempAccommodationItem({...tempAccommodationItem, tarih2: e.target.value})}
                                className="w-full px-2 py-1 text-xs border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                              />
                            </td>
                            <td className="px-3 py-2">
                              <input
                                ...
                                onChange={(e) => setTempAccommodationItem({...tempAccommodationItem, tarih3: e.target.value})}
                                className="w-full px-2 py-1 text-xs border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                              />
                            </td>
                            <td className="px-3 py-2">
                              <input
                                ...
                                onChange={(e) => setTempAccommodationItem({...tempAccommodationItem, tarih4: e.target.value})}
                                className="w-full px-2 py-1 text-xs border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                              />
                            </td>
                            <td className="px-3 py-2">
                              <input
                                ...
                                onChange={(e) => setTempAccommodationItem({...tempAccommodationItem, tarih5: e.target.value})}
                                className="w-full px-2 py-1 text-xs border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                              />
                            </td>
                            <td className="px-3 py-2">
                              <input
                                ...
                                onChange={(e) => setTempAccommodationItem({...tempAccommodationItem, tarih6: e.target.value})}
                                className="w-full px-2 py-1 text-xs border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                              />
                            </td>
                            <td className="px-3 py-2">
                              <input
                                ...
                                onChange={(e) => setTempAccommodationItem({...tempAccommodationItem, tarih7: e.target.value})}
                                className="w-full px-2 py-1 text-xs border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                              />
                            </td>
                            <td className="px-3 py-2">
                          ...
                          <>
                            <td className="px-3 py-2">{item.oda_no || '-'}</td>
                            <td className="px-3 py-2">{item.oda_tipi || '-'}</td>
                            <td className="px-3 py-2">{item.yatak_tipi || '-'}</td>
                            <td className="px-3 py-2">{item.isim || '-'}</td>
                            <td className="px-3 py-2">{item.soyisim || '-'}</td>
                            <td className="px-3 py-2">{item.oda_no || '-'}</td>
                            <td className="px-3 py-2">{item.oda_notu || '-'}</td>
                            <td className="px-3 py-2">{item.gelis_tarihi || '-'}</td>
                            <td className="px-3 py-2">{item.gelis_ucus_kodu || '-'}</td>
                            <td className="px-3 py-2">{item.gelis_ucak_kalkis || '-'}</td>
                            <td className="px-3 py-2">{item.gelis_ucak_inis || '-'}</td>
                            <td className="px-3 py-2">{item.cikis_tarihi || '-'}</td>
                            <td className="px-3 py-2">{item.donus_ucus_kodu || '-'}</td>
                            <td className="px-3 py-2">{item.donus_ucak_kalkis || '-'}</td>
                            <td className="px-3 py-2">{item.donus_ucak_inis || '-'}</td>
                            ...
                            <td className="px-3 py-2">{item.geceleme || '-'}</td>
          ...
          {accommodationStats.allDates.length > 0 && (
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
              <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
                <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Günlük Inhouse Kontrolü</h3>
              </div>
              <div className="p-4">
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  Toplam Oda: {accommodationStats.grandTotalRooms} | 
                  Toplam Pax: {accommodationStats.grandTotalPax} | 
                  Tarih Sayısı: {accommodationStats.allDates.length}
                </p>
              </div>
            </div>
          )}
