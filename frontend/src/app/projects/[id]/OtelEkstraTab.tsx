                      ...
                      <table className="w-full text-xs">
                        <thead className="bg-gray-100 dark:bg-gray-700">
                          <tr>
                            ...
                            >
                              OTEL/TEDARIKÇİ {hotelExtraSortField === 'hotel' && (hotelExtraSortDirection === 'asc' ? '↑' : '↓')}
                            </th>
                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <td className="px-2 py-2">
                                  <input
                                    ...
                                    onBlur={(e) => {
                                      ...
                                      const currency = tempHotelExtraItem?.currency || 'TRY';
                                      const rate = tempHotelExtraItem?.exchangeRate || 1;
                                      const totalTRY = currency === 'TRY' ? value : value * rate;
                                ...
                                <td className="px-2 py-2">
                                  <select
                                    ...
                                    onChange={(e) => {
                                      ...
                                      if (newCurrency === 'TRY') {
                                        newRate = 1;
                                      } else if (tempHotelExtraItem?.currency === 'TRY' && newCurrency !== 'TRY') {
                                ...
                                <td className="px-2 py-2">
                                  <input
                                    ...
                                    onChange={(e) => {
                                      ...
                                      const newAmount = currency === 'TRY' ? numericValue : (rate > 0 ? numericValue / rate : 0);
                                    ...
                                    onBlur={(e) => {
                                      ...
                                      const newAmount = currency === 'TRY' ? value : (rate > 0 ? value / rate : 0);
                          ...
                          {filteredHotelExtras.length === 0 && editingHotelExtraIndex === null ? (
                            ...
                            filteredHotelExtras.map((extra, index) => {
                              const originalIndex = hotelExtras.findIndex((e: any) => e.id === extra.id);
                              return (
                              <tr key={extra.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                                {editingHotelExtraIndex === originalIndex && !isNewHotelExtraItem ? (
                                  // Edit Mode
                                  <>
                                    <td className="px-2 py-2">
                                      <input
