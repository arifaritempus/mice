        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-sm border border-slate-200 dark:border-gray-700 text-slate-900 dark:text-slate-100 flex-1 min-h-0 flex flex-col w-full relative">
          ...
          {filteredItems.length === 0 && (
            <div className="text-center py-20">
              ...
              <h3 className="text-lg font-medium text-slate-900 dark:text-slate-100">Faturalanacak kalem bulunamadı</h3>
              <p className="text-slate-600 dark:text-slate-300">Tüm satış kalemleri faturası kesilmiş veya filtreye uygun kayıt yok.</p>
