      ...
      <div className="flex flex-col md:flex-row md:items-start justify-start gap-6">
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="px-3 py-1 bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white rounded-xl font-bold text-[11px] shadow-lg shadow-orange-500/25 disabled:opacity-50 disabled:shadow-none transition-all flex items-center gap-2 h-fit"
          >
