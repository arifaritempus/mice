    ...
    <div className="h-full w-full p-6 sm:p-8 flex flex-col gap-6 overflow-hidden font-sans text-white">
      <div className="w-full min-w-0 flex-1 flex flex-col">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          {canCreate(Module.OPERATIONS) && (
            <button
              ...
              className="bg-blue-500/20 text-blue-400 border border-blue-500/30 hover:bg-blue-500/30 shadow-[0_0_15px_rgba(59,130,246,0.15)] px-4 py-2 rounded-xl transition-all duration-300 text-xs font-medium"
            >
              Yeni Operasyon Ekle
            </button>
          )}
        ...
        <div className="flex flex-wrap items-center gap-2 mb-4 bg-[#0f172a]/40 backdrop-blur-md border border-white/10 rounded-xl p-2 shadow-sm">
          ...
          <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg border bg-blue-500/10 border-blue-500/20 text-blue-300">
          ...
          <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg border bg-orange-500/10 border-orange-500/20 text-orange-300">
            <span className="text-[10px] font-medium uppercase tracking-wider">
              Beklemede
            </span>
            <span className="font-bold text-xs bg-black/20 px-1.5 py-0.5 rounded-md">
          ...
          <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg border bg-teal-500/10 border-teal-500/20 text-teal-300">
            <span className="text-[10px] font-medium uppercase tracking-wider">
              Onaylandı
            </span>
            <span className="font-bold text-xs bg-black/20 px-1.5 py-0.5 rounded-md">
          ...
          <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg border bg-emerald-500/10 border-emerald-500/20 text-emerald-300 ml-auto mr-1">
            <span className="text-[10px] font-medium uppercase tracking-wider">
              Toplam Tutar
            </span>
            <span className="font-bold text-xs bg-black/20 px-1.5 py-0.5 rounded-md">
        ...
        <div className="bg-[#0f172a]/40 backdrop-blur-md border border-white/10 rounded-2xl w-full min-w-0 flex-grow shrink-0 flex flex-col relative overflow-hidden">
          <div className="w-full flex-1 overflow-auto custom-scrollbar">
            <table className="min-w-full divide-y divide-white/10">
              <thead className="bg-[#1e293b]/95 sticky top-0 z-10 backdrop-blur-md shadow-sm border-b border-white/10">
                <tr>
                  <th className="px-6 py-4 text-left text-xs font-medium text-white uppercase tracking-wider border-b border-white/10">
                    Teklif Ref.
                  </th>
                  <th className="px-6 py-4 text-left text-xs font-medium text-white uppercase tracking-wider border-b border-white/10">
                    Tedarikçi
            ...
            <form onSubmit={handleCreateOperation}>
              <div className="space-y-4 text-white">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2.5 bg-[#0f172a]/40 border border-white/10 rounded-xl outline-none focus:ring-1 focus:ring-blue-500/50 focus:border-blue-500/50 text-sm text-white transition-all appearance-none"
                    required
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    required
                  >
                    <option value="sejour" className="bg-[#0f172a]">
                      Sejour
                    </option>
                    <option value="transfer" className="bg-[#0f172a]">
                      MICE Transfer
                    </option>
                    <option value="guide" className="bg-[#0f172a]">
                      Kokartlı Rehber
                    </option>
                    <option value="part_time" className="bg-[#0f172a]">
                      Part-Time
                    </option>
                    <option value="extra_service" className="bg-[#0f172a]">
                      Ekstra Hizmet
                    </option>
                  </select>
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-[#0f172a]/40 border border-white/10 rounded-xl outline-none focus:ring-1 focus:ring-blue-500/50 focus:border-blue-500/50 text-sm text-white transition-all"
                    required
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2.5 bg-[#0f172a]/40 border border-white/10 rounded-xl outline-none focus:ring-1 focus:ring-blue-500/50 focus:border-blue-500/50 text-sm text-white transition-all resize-none"
                    rows={3}
                    required
                  />
                </div>
              ...
              <div className="flex justify-end space-x-3 mt-8 pt-4 border-t border-white/10">
                <button
                  ...
                  className="px-6 py-2 text-xs font-semibold text-white hover:text-white transition-colors uppercase"
                >
                  İPTAL
                </button>
                <button
        ...
        {success && (
          <div className="fixed top-4 right-4 bg-emerald-500/20 border border-emerald-500/30 text-emerald-300 px-4 py-3 rounded-xl z-50 backdrop-blur-md shadow-[0_0_15px_rgba(16,185,129,0.15)] flex items-center justify-between gap-4">
