    ...
    try {
      ...
      if (storedPermissions) {
        ...
        currentPermissions = [
          ...
          {
            id: "dashboard_edit",
            name: "Dashboard Düzenleme",
            description: "Dashboard ayarlarını düzenleme",
            module: "dashboard",
            is_active: true,
          },
          ...
          },
          {
            ...
            description: "Mevcut projeleri düzenleme",
            module: "projects",
            is_active: true,
          },
          {
          ...
          {
            id: "sejour_view",
            name: "Sejour Görüntüleme",
            description: "Sejour rezervasyonlarını görüntüleme",
            module: "sejour",
            is_active: true,
          },
          {
            id: "sejour_create",
            name: "Sejour Oluşturma",
            description: "Yeni sejour rezervasyonu oluşturma",
            module: "sejour",
            is_active: true,
          },
          {
            id: "sejour_edit",
            name: "Sejour Düzenleme",
            description: "Mevcut sejour rezervasyonlarını düzenleme",
            module: "sejour",
            is_active: true,
          },
          {
            id: "sejour_delete",
            name: "Sejour Silme",
            description: "Sejour rezervasyonlarını silme",
            module: "sejour",
            is_active: true,
          },
          ...
          {
            id: "operations_view",
            name: "Operasyon Görüntüleme",
            description: "Operasyon işlemlerini görüntüleme",
            module: "operations",
            is_active: true,
          },
          {
            id: "operations_create",
            name: "Operasyon Oluşturma",
            description: "Yeni operasyon işlemi oluşturma",
            module: "operations",
            is_active: true,
          },
          {
            id: "operations_edit",
            name: "Operasyon Düzenleme",
            description: "Mevcut operasyon işlemlerini düzenleme",
            module: "operations",
            is_active: true,
          },
          {
            id: "operations_delete",
            name: "Operasyon Silme",
            description: "Operasyon işlemlerini silme",
            module: "operations",
            is_active: true,
          },
          ...
          },
          {
            ...
            description: "Mevcut kullanıcıları düzenleme",
            module: "users",
            is_active: true,
          },
          {
            ...
            description: "Kullanıcıları silme",
            module: "users",
            is_active: true,
          },
