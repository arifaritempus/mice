...
const sections = [
  {
    ...
    tips: [
      "Grafik ve Liste görünümleri arasında geçiş yapabilirsiniz.",
      "Hızlı ara butonu ile her şeye saniyeler içinde ulaşın.",
    ],
  },
  {
    id: "projects",
    ...
    description:
      "Projelerinizi uçtan uca yönetin. Satış, alış, operasyonel detaylar ve finansal takibi buradan yapın.",
    tips: [
      "Proje durumlarını güncelleyerek ekibinizi bilgilendirin.",
      "Proje içindeki kalemleri Excel'e aktarabilirsiniz.",
    ],
  },
  {
    id: "sejour",
    ...
    description:
      "Otel rezervasyonları ve misafir voucher işlemlerini yönetin. PDF voucher oluşturma ve paylaşma özellikleri sunar.",
    tips: [
      "Voucher indirirken temanın beyaz olduğundan emin olun.",
      "Otel adres ve iletişim bilgilerini eksiksiz girin.",
    ],
  },
  {
    id: "operations",
    ...
    description:
      "Transfer, uçak bileti, rehber ve part-time personel operasyonlarını organize edin.",
    tips: [
      "Transfer saatlerini ve plaka bilgilerini sisteme girin.",
      "Bilet PNR numaralarını hızlıca kopyalayabilirsiniz.",
    ],
  },
  {
    id: "finance",
    ...
    description:
      "Fatura, ödeme ve tahsilat süreçlerini takip edin. Borç/Alacak durumlarını kontrol altında tutun.",
    tips: [
      "Ödeme planlarını projelere sadık kalarak oluşturun.",
      "Döviz kurlarını güncel tutmayı unutmayın.",
    ],
  },
  {
    id: "hr",
    ...
    description:
      "Personel ve rehber atamalarını yönetin. Çalışma saatlerini ve hakedişleri takip edin.",
    tips: [
      "Rehberlerin kokart geçerlilik sürelerini kontrol edin.",
      "Part-time personel listesini güncel tutun.",
    ],
  },
];
...
export default function HelpGuideModal({
  ...
  return createPortal(
    <AnimatePresence mode="wait">
      {isOpen && (
        <div
          key="help-guide-modal-wrapper"
          className="fixed inset-0 z-[10000] flex items-center justify-center p-2 md:p-6"
        >
          <motion.div
                    ...
                    .map((section) => (
                      ...
                      >
                        <div className="space-y-4">
                          <div
                            className={`w-16 h-16 rounded-3xl ${section.bgColor} ${section.color} flex items-center justify-center mb-6 shadow-sm`}
                          >
