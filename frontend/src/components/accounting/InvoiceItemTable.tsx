...
export default function InvoiceItemTable({
  ...
  const filteredItems = enableInternalSearch
    ? items.filter((item) => {
      ...
      filteredItems.forEach((item) => {
        ...
        if (!groups[groupId]) {
          groups[groupId] = {
            ...
            category_name:
              item.project?.quote_type === "SEJOUR"
                ? "SEJOUR TOPLAM"
                : "PROJE TOPLAM",
        ...
        <table className="w-full table-fixed min-w-[1000px] divide-y divide-gray-200 dark:divide-gray-700 text-sm relative">
          <thead className="bg-slate-100/80 dark:bg-slate-800/70 sticky top-0 z-10 backdrop-blur-sm">
            <tr>
              <th className="px-2.5 py-2.5 text-left w-10">
                <input
                  ...
                  checked={
                    ...
                    displayRows.every((r) => isRowSelected(r))
                  }
                  onChange={(e) => {
                    if (e.target.checked) {
              ...
              <th className="px-2.5 py-2.5 text-right text-[10px] font-semibold text-blue-600 dark:text-blue-400 uppercase tracking-wider w-[8%]">
                Bakiye
              </th>
              ...
              return (
                  ...
                  <td className="px-2.5 py-2.5 min-w-[160px]">
                    <div className="flex gap-1.5 items-center mb-0.5">
                      <span
                        className={`px-1.5 py-0.5 rounded text-[9px] font-bold ${badgeCls}`}
                      >
                        {badge}
                      </span>
                  ...
                  <td className="px-2.5 py-2.5 min-w-[110px]">
                    {dateStart || dateEnd ? (
                  ...
                  <td className="px-2.5 py-2.5">
                    <div
                      className="font-medium text-gray-800 dark:text-gray-300 truncate text-[11px] pr-2"
                  ...
                  <td className="px-2.5 py-2.5">
                    <div
                      className="font-medium text-blue-600 dark:text-blue-400 truncate text-[11px] pr-2"
                      title={codeDisplay}
                    >
                      {codeDisplay}
                    </div>
                  ...
                  <td className="px-2.5 py-2.5 text-right text-gray-700 dark:text-gray-300 whitespace-nowrap text-[11px]">
