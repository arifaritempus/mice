...
export default function ConfirmModal({
  ...
  const getButtonClasses = () => {
    switch (type) {
      case "danger":
        return "bg-red-600 hover:bg-red-700 shadow-xl shadow-red-600/20";
      case "success":
        return "bg-green-600 hover:bg-green-700 shadow-xl shadow-green-600/20";
      case "info":
        return "bg-blue-500 hover:bg-blue-500/90 shadow-xl shadow-blue-600/20";
      default:
        return "bg-blue-500 hover:bg-blue-500/90 shadow-xl shadow-blue-600/20";
    }
  };
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-6">
          ...
          >
            {/* Icon Wrapper */}
            <div
              className={`flex items-center justify-center w-24 h-24 ${getThemeClasses()} rounded-[2.5rem] mx-auto mb-8 transition-transform duration-500 hover:scale-110`}
            >
              {getIcon()}
            </div>
