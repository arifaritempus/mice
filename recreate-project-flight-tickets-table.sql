-- PROJECT FLIGHT TICKETS TABLOSU YENİDEN OLUŞTURMA
...
CREATE INDEX idx_project_flight_tickets_project_id ON project_flight_tickets(project_id);
CREATE INDEX idx_project_flight_tickets_biletleme_tarihi ON project_flight_tickets(biletleme_tarihi);
CREATE INDEX idx_project_flight_tickets_tedarikci ON project_flight_tickets(tedarikci);
CREATE INDEX idx_project_flight_tickets_havayolu ON project_flight_tickets(havayolu);
CREATE INDEX idx_project_flight_tickets_pnr ON project_flight_tickets(pnr);
...
-- 8. Başarı mesajı
SELECT 'project_flight_tickets tablosu başarıyla yeniden oluşturuldu!' as message;
